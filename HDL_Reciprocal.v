// -------------------------------------------------------------
// 
// File Name: /home/yangli18/Documents/yangzai/PFC/qr_simulink/HDL/qr10/fourxfour_designfxdpt_givens/HDL_Reciprocal.v
...
// Source Path: fourxfour_designfxdpt_givens/fourxfour_designfxdpt/Givens_Boundary_Cell2/HDL Reciprocal
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HDL_Reciprocal
  ...
  HDL_Reciprocal_core u_core_stage1_inst (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .enb_2_1_0(enb_2_1_0),
                                          .xin(x0),  // ufix49_En47
  ...
  HDL_Reciprocal_core u_core_stage2_inst (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .enb_2_1_0(enb_2_1_0),
  ...
  HDL_Reciprocal_core u_core_stage3_inst (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .enb_2_1_0(enb_2_1_0),
