// -------------------------------------------------------------
// 
// File Name: /home/yangli18/Documents/yangzai/PFC/qr_simulink/HDL/qr10/fourxfour_designfxdpt_givens/Givens_Boundary_Cell.v
...
// -------------------------------------------------------------
// 
// Module: Givens_Boundary_Cell
// Source Path: fourxfour_designfxdpt_givens/fourxfour_designfxdpt/Givens_Boundary_Cell
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Givens_Boundary_Cell
  ...
  Sqrt_block2 u_Sqrt (.din(Add1_out1),  // ufix49_En28
                      .dout(Sqrt_out1)  // ufix49_En28
                     );
                      
  /*sqrt_nonstore u_Sqrt_3 
                                  (.clk(clk),
                                   .rst(reset),
  ...
  HDL_Reciprocal_block2 u_HDL_Reciprocal (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .enb_2_1_0(enb_2_1_0),
...
endmodule  // Givens_Boundary_Cell
